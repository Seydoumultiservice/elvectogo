  ...
  return (
    <div className="fixed bottom-6 right-6 flex flex-col gap-3 z-50">
      ...
      <a
        ...
        className="group flex items-center justify-center w-14 h-14 bg-elvec-600 hover:bg-elvec-700 text-white rounded-full shadow-lg transition-all duration-300 hover:scale-110"

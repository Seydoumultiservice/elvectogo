      ...
      <div className="bg-elvec-900 text-white py-2 px-4">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="w-full md:w-auto flex justify-end space-x-3">
            <a href="https://web.facebook.com/p/ELVEC-TOGO-100085057637931/?_rdc=1&_rdr" target="_blank" rel="noopener noreferrer" className="text-white hover:text-elvec-300 transition-colors duration-300">
            ...
            <a href="https://www.linkedin.com/company/elvec-togo?trk=similar-pages" target="_blank" rel="noopener noreferrer" className="text-white hover:text-elvec-300 transition-colors duration-300">
            ...
            <a href="https://www.tiktok.com/@salvaduciel763?lang=fr" target="_blank" rel="noopener noreferrer" className="text-white hover:text-elvec-300 transition-colors duration-300">
            ...
            <a href="https://instagram.com/elvectogo" target="_blank" rel="noopener noreferrer" className="text-white hover:text-elvec-300 transition-colors duration-300">

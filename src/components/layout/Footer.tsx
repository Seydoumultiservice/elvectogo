              ...
              <li className="flex flex-col space-y-2">
                <div className="flex items-center">
                  ...
                  <div className="flex flex-col">
                    <span className="text-gray-300">Commercial: +228 70 60 03 06</span>
                    <span className="text-gray-300">Direction: +228 92 74 82 70</span>
                  </div>
                </div>
              </li>
              <li className="flex">
      ...
      <div className="bg-elvec-700 py-4">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left text-gray-200 text-sm">
            ...
            <Link
              to="/login"
              className="mt-2 md:mt-0 text-white/60 hover:text-white transition-colors"
